...
export default function HomePage() {
  return (
    <main id="main" style={mainContainerStyle}>
      ...
      <p>
        Import a setlist from setlist.fm (URL or setlist ID), preview the tracks, fix matches if
        needed, then create an Apple Music playlist in your account.
      </p>
      <ol style={{ marginTop: '1.5rem', paddingLeft: '1.5rem' }}>
        ...
        <li>
          <strong>Matching</strong> – Confirm or correct Apple Music track matches
        </li>
        <li>
